...
def move_highlight(  # noqa: PLR0912
    ...
    if show_save_option and old_idx == max_index:
        ...
        menu_win.chgat(win_h - 2, (win_w - len(save_label)) // 2, len(save_label), get_color("settings_save"))
...
def highlight_line(
    ...
    if ui_state.current_window == 0:
        color_old = get_color("channel_selected") if old_idx == ui_state.selected_channel else get_color("channel_list")
