            ...
            if min_length == max_length and max_length is not None:
                if length != min_length:
                    invalid_input(
                        input_win,
                        t(
                            "ui.error.value_exact_length",
                            default="Value must be exactly {length} characters long.",
                            length=min_length,
                        ),
                        redraw_func=redraw_input_win,
                    )
                ...
                if length < min_length:
                    invalid_input(
                        input_win,
                        t(
                            "ui.error.value_min_length",
                            default="Value must be at least {length} characters long.",
                            length=min_length,
                        ),
                        redraw_func=redraw_input_win,
                    )
                ...
                if max_length is not None and length > max_length:
                    invalid_input(
                        input_win,
                        t(
                            "ui.error.value_max_length",
                            default="Value must be no more than {length} characters long.",
                            length=max_length,
                        ),
                        redraw_func=redraw_input_win,
                    )
